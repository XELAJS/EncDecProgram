...
"}")
        ...
        self.textEdit_NText = QtWidgets.QTextEdit(self.frame)
        self.textEdit_NText.setGeometry(QtCore.QRect(20, 200, 411, 271))
        self.textEdit_NText.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.011, y1:0, x2:1, y2:0, stop:0 rgba(70, 180, 255, 223), stop:1 rgba(255, 255, 255, 255));")
        self.textEdit_NText.setObjectName("textEdit_NText")
...
"color: rgb(0, 0, 255);")
        ...
        self.comboBox_Encryptions.addItem(" ")
        self.comboBox_Encryptions.addItem("AES")
        self.comboBox_Encryptions.addItem("Fernet")
        self.comboBox_Encryptions.addItem("Sezar")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Text Name:"))
